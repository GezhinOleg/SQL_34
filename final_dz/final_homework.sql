...
-- - Подзапрос
/*
 * Подзапрос получает код самолета с самый большой дальностью (с помощью сортировки и ограничения вывода).
...
/*
 * Выбираю только те рейсы, которые вылетели (поле actual_departure заполнено)
 * Задержка расчитывается с помощью вычитания.
